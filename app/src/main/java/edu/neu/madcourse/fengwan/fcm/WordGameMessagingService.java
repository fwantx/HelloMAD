...
import edu.neu.madcourse.fengwan.LeaderboardActivity;
import edu.neu.madcourse.fengwan.R;

public class WordGameMessagingService extends FirebaseMessagingService {
    private final static String TAG = WordGameMessagingService.class.getSimpleName();
